...
INSTANTIATE_TEST_SUITE_P(
    InterestingSignedIntegers, SignedInt32RoundTrip,
...
INSTANTIATE_TEST_SUITE_P(
    InterestingUnsignedIntegers, UnsignedInt32RoundTrip,
...
INSTANTIATE_TEST_SUITE_P(
    InterestingUnsignedLongs, UnsignedInt64RoundTrip,
    testing::ValuesIn<std::vector<TestData<uint64_t>>>(
        {{.decoded = 0, .encoded = {0x00}},
         ...
         {.decoded = std::numeric_limits<uint64_t>::max(),
          .encoded = {0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
                      0x1}}}));

INSTANTIATE_TEST_SUITE_P(
    InterestingSignedLongs, SignedInt64RoundTrip,
